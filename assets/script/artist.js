...
window.addEventListener("DOMContentLoaded", e => {
  e.preventDefault();
  fetch_name_artist().then(updatedArtistName => {
...
const generate_popular_songs = (current_song, i) => {
  ...
  track_container.addEventListener("mouseleave", () => {
    switch (i) {
      case 1:
        track_number.innerText = "1";

        break;
      case 2:
        track_number.innerText = "2";

        break;
      case 3:
        track_number.innerText = "3";

        break;
      case 4:
        track_number.innerText = "4";

        break;
      case 5:
        track_number.innerText = "5";
...
const generate_last_album = artist => {
  ...
  divArtist.className =
    "d-flex align-items-center mt-2 ms-2 px-2 rounded-pill bg-light text-dark d-inline-block h-auto w-75 gap-3";
